...
import { formatDate, getInitials, getStatusVariant, formatStatus } from '@/pages/dashboard/service-orders/utils'
...
defineEmits(['page-change', 'select-order'])
</script>
            ...
            <Table>
                ...
                <TableRow v-else-if="orders.length === 0">
                    ...
                    <div class="flex flex-col items-center justify-center space-y-3">
                        ...
                        <div class="space-y-1">
                        <h3 class="font-semibold text-lg tracking-tight">No history found</h3>
                        <p class="text-sm text-muted-foreground max-w-sm mx-auto">
                            Completed and cancelled service orders will appear here.
                        </p>
                        </div>
                    </div>
                    </TableCell>
                ...
                >
                    ...
                    <TableCell>
                         <span class="font-mono font-medium">₱{{ Number(order.totalAmount).toLocaleString() }}</span>
                    </TableCell>
                    <TableCell>
